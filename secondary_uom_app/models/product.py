...
class ProductTemplate(models.Model):
    ...
    secondary_uom_name = fields.Char(string='UoM', related='secondary_uom_id.name', readonly=True)
    ...
    """
    def _compute_second_qty_dict(self):
        variants_available = {
...
class Product(models.Model):
	...
	def _search_second_qty_available(self, operator, value):
		...
		return self._search_product_quantity(operator, value, 'second_qty_available')
	...
	def _search_product_quantity(self, operator, value, field):
		...
		if field not in ('second_qty_available', 'qty_available', 'virtual_available', 'incoming_qty', 'outgoing_qty', 'free_qty'):
